<div class="blog-comments">
    ...
    <div id="comment-1" class="comment">
        <div class="d-flex">
            <div class="comment-img"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/comments-1.jpg" alt=""></div>
            <div>
    ...
    <div id="comment-2" class="comment">
        <div class="d-flex">
            <div class="comment-img"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/comments-2.jpg" alt=""></div>
            <div>
        ...
        <div id="comment-reply-1" class="comment comment-reply">
            <div class="d-flex">
                <div class="comment-img"><img
                        src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/comments-3.jpg" alt=""></div>
                <div>
            ...
            <div id="comment-reply-2" class="comment comment-reply">
                <div class="d-flex">
                    <div class="comment-img"><img
                            src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/comments-4.jpg" alt="">
                    </div>
                    <div>
    ...
    <div id="comment-3" class="comment">
        <div class="d-flex">
            <div class="comment-img"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/comments-5.jpg" alt=""></div>
            <div>
    ...
    <div id="comment-4" class="comment">
        <div class="d-flex">
            <div class="comment-img"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/comments-6.jpg" alt=""></div>
            <div>
